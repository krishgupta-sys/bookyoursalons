            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Card className="border-2 border-purple-200 bg-purple-50">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>Select a plan to get started with BookYourSalons</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div 
                      onClick={() => setFormData({ ...formData, subscription_plan: '1_month' })}
                      className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${
                        formData.subscription_plan === '1_month' 
                    ...
                    <div 
                      onClick={() => setFormData({ ...formData, subscription_plan: '3_months' })}
                      className={`p-4 rounded-lg border-2 cursor-pointer transition-all relative ${
                        formData.subscription_plan === '3_months' 
                          ? 'border-purple-600 bg-purple-100' 
                          : 'border-gray-200 bg-white hover:border-purple-300'
                      }`}
                    >
                  ...
                  <div className="bg-white p-4 rounded-lg border">
                    ...
                    <div className="space-y-3">
                      <div className="p-3 bg-blue-50 rounded text-sm">
                        ...
                        <p className="text-blue-700">Pay ₹{SUBSCRIPTION_PLANS[formData.subscription_plan].price} via UPI</p>
                        <p className="text-blue-700 mt-1 font-mono">UPI: 6205777957-i24a@axl</p>
                        <Button
                          type="button"
                          variant="outline"
                          size="sm"
                          ...
                          onClick={() => {
                            const amount = SUBSCRIPTION_PLANS[formData.subscription_plan].price;
                            const upiLink = `upi://pay?pa=6205777957-i24a@axl&pn=SalonAdmin&am=${amount}&cu=INR&tn=Salon_Registration_${formData.subscription_plan}`;
                      ...
                      <div>
                        <label className="block text-sm font-medium mb-1">Payment Reference/UTR Number *</label>
                        <Input
                      ...
                      <div>
                        ...
                        />
                        {paymentScreenshot && (
                          <img src={paymentScreenshot} alt="Payment screenshot" className="mt-2 h-32 object-contain rounded border" />
                        )}
                      </div>
                    </div>
                  </div>
              ...
              <Button data-testid="submit-registration-btn" type="submit" className="w-full" disabled={loading}>
                {loading ? 'Registering...' : 'Register & Submit Payment'}
              </Button>
            </form>
          </CardContent>
        </Card>
